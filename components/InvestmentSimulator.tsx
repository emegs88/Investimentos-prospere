    ...
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        >
          ...
          <div className="flex items-center gap-3">
            <Store className="w-5 h-5 text-prospere" />
            <input
              type="number"
              min="1"
              max="10"
        ...
        >
          ...
          <div className="flex items-center gap-2 mb-3">
            <BarChart3 className="w-5 h-5 text-prospere" />
            <select
              ...
              className="flex-1 bg-white/5 border border-white/20 rounded-lg px-4 py-3 text-white text-sm font-semibold focus:outline-none focus:border-prospere focus:ring-2 focus:ring-prospere/50"
            >
      ...
      >
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-lg font-bold text-white">Vendas Mensais por Cenário</h3>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <motion.div
          ...
          className="p-6 bg-gradient-to-br from-prospere/20 to-prospere/10 border-2 border-prospere/50 rounded-xl"
        >
          <div className="flex items-center gap-3 mb-3">
            <DollarSign className="w-6 h-6 text-prospere" />
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <Percent className="w-6 h-6 text-prospere" />
            <span className="text-sm text-gray-400">Comissão Mensal</span>
          </div>
          <p className="text-2xl font-bold text-white">
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <Calendar className="w-6 h-6 text-prospere" />
        ...
        >
          <div className="flex items-center gap-3 mb-3">
            <TrendingUp className="w-6 h-6 text-prospere" />
            <span className="text-sm text-gray-400">ROI ({paymentMonths}m)</span>
          </div>
          <p className={`text-2xl font-bold ${calculations.roi >= 0 ? 'text-green-400' : 'text-red-400'}`}>
      ...
      >
        <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
          <TrendingUp className="w-5 h-5 text-prospere" />
        ...
        <div className="relative h-64">
          ...
          {/* Barras do gráfico */}
          <div className="flex items-end justify-between h-full gap-1 sm:gap-2 mt-8 overflow-x-auto pb-2 scrollbar-thin scrollbar-thumb-prospere scrollbar-track-transparent">
            {chartData.map((data, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-black/90 text-white text-xs px-2 py-1 rounded whitespace-nowrap z-10 pointer-events-none">
                  ...
                  <span className="text-xs text-gray-500 mt-2 sm:hidden">{data.month % 3 === 0 ? data.month : ''}</span>
                </motion.div>
              )
            })}
          </div>
        ...
        <div className="flex items-center gap-6 mt-4 text-sm">
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 bg-prospere rounded" />
          ...
          <div className="text-gray-500 text-xs ml-auto">
            Linha tracejada: Payback em {calculations.paybackMonths.toFixed(1)} meses
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="p-6 bg-gradient-to-br from-prospere/20 to-prospere/10 border-2 border-prospere/50 rounded-xl"
      >
        <h3 className="text-lg font-bold text-white mb-4">Resumo do Investimento</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <p className="text-sm text-gray-400 mb-1">Retorno Total ({paymentMonths} meses)</p>
          ...
          <div>
            ...
            <p className={`text-xl font-bold ${calculations.netProfit >= 0 ? 'text-green-400' : 'text-red-400'}`}>
              {formatBRL(calculations.netProfit)}
            </p>
          </div>
          <div>
            <p className="text-sm text-gray-400 mb-1">Comissão por Loja/Mês</p>
            <p className="text-xl font-bold text-white">
